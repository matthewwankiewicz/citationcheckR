...
Once you have installed the package you are now able to use the functions available. The vingnettes below have examples for how to use each of the function in the package.
